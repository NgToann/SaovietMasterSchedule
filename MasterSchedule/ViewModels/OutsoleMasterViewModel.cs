...
namespace MasterSchedule.ViewModels
{
    public class OutsoleMasterViewModel : INotifyPropertyChanged
    {
        ...
        private string _ReleasedToWHInspectionQuantity;
        public string ReleasedToWHInspectionQuantity
        {
            get { return _ReleasedToWHInspectionQuantity; }
            set
            {
                _ReleasedToWHInspectionQuantity = value;
                OnPropertyChanged("ReleasedToWHInspectionQuantity");
            }
        }

        public string OutsoleWHCheckingCurrent { get; set; }
        public Brush OutsoleWHCheckingCurrentBackground { get; set; } = Brushes.Transparent;
