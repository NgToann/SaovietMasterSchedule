...
namespace MasterSchedule.ViewModels
{
    public class SewingMasterViewModel : INotifyPropertyChanged
    {
        ...
        private string _CutBStartDate;
        public string CutBStartDate
        {
            get { return _CutBStartDate; }
            set
            {
                _CutBStartDate = value;
                OnPropertyChanged("CutBStartDate");
            }
        }

        private string _AtomCutA;
        public string AtomCutA
        {
            get { return _AtomCutA; }
            set
            {
                _AtomCutA = value;
                OnPropertyChanged("AtomCutA");
            }
        }

        private string _AtomCutB;
        public string AtomCutB
        {
            get { return _AtomCutB; }
            set
            {
                _AtomCutB = value;
                OnPropertyChanged("AtomCutB");
            }
        }
        private string _LaserCutA;
        public string LaserCutA
        {
            get { return _LaserCutA; }
            set
            {
                _LaserCutA = value;
                OnPropertyChanged("LaserCutA");
            }
        }

        private string _LaserCutB;
        public string LaserCutB
        {
            get { return _LaserCutB; }
            set
            {
                _LaserCutB = value;
                OnPropertyChanged("LaserCutB");
            }
        }

        private string _HuasenCutA;
        public string HuasenCutA
        {
            get { return _HuasenCutA; }
            set
            {
                _HuasenCutA = value;
                OnPropertyChanged("HuasenCutA");
            }
        }

        private string _HuasenCutB;
        public string HuasenCutB
        {
            get { return _HuasenCutB; }
            set
            {
                _HuasenCutB = value;
                OnPropertyChanged("HuasenCutB");
            }
        }

        private string _ComelzCutA;
        public string ComelzCutA
        {
            get { return _ComelzCutA; }
            set
            {
                _ComelzCutA = value;
                OnPropertyChanged("ComelzCutA");
            }
        }

        private string _ComelzCutB;
        public string ComelzCutB
        {
            get { return _ComelzCutB; }
            set
            {
                _ComelzCutB = value;
                OnPropertyChanged("ComelzCutB");
            }
        }
