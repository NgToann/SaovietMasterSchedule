...
namespace MasterSchedule.Controllers
{
    class AssemblyReleaseController
    {
        ...
        public static List<AssemblyReleaseModel> SelectByPOIsEnable()
        {
            SaovietMasterScheduleEntities db = new SaovietMasterScheduleEntities();

            return db.ExecuteStoreQuery<AssemblyReleaseModel>("EXEC spm_SelectAssemblyReleaseByPOIsEnable").ToList();
        }
