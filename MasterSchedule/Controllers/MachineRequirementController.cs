...
namespace MasterSchedule.Controllers
{
    class MachineRequirementController
    {
        ...
        public static bool Insert(MachineRequirementModel_OLD model)
        {
            ...
            SaovietMasterScheduleEntities db = new SaovietMasterScheduleEntities();
            if (db.ExecuteStoreCommand(@"EXEC spm_InsertMachineRequirement @ArticleNo, @ShoeName, @PM, @CuttingQuantity, @CuttingWorker, @CuttingArmClicker, @CuttingBeam, @CuttingCutStrap, @CuttingLaser, @CuttingPuncherHole, @CuttingSkiving, @PrepWorker, @PrepVerticalHF, @PrepHorizontalHF, @PrepOnlineHeatPress, @PrepAutoHF, @PrepInye, @PrepHotmeltMachine, @SewingQuantity, @SewingWorker, @SewingSmallComputer, @SewingBigComputer, @SewingUltrasonic, @Sewing4NeedleFlat, @Sewing4NeedlePost, @SewingLongTable, @SewingEyeleting, @SewingZZBinding, @SewingHotmeltMachine, @SewingHandHeldHotmelt, @SewingStationaryHHHotmelt, @StockfitQuantity, @StockfitWorker, @StockfitVerticalBuffing, @StockfitHorizontalBuffing, @StockfitSideBuffing, @StockfitOutsoleStitching, @StockfitAutoBuffing, @StockfitHydraulicCutting, @StockfitPadPrinting, @AssemblyQuantity, @AssemblyWorker, @AssemblyToeLasting, @AssemblySideLasting, @AssemblyHeelLasting, @AssemblySidePress, @AssemblyTopDown, @AssemblyHotmeltMachine, @AssemblySocklinerHotmelt, @AssemblyVWrinkleRemover", 
                                                                           @ArticleNo, @ShoeName, @PM, @CuttingQuantity, @CuttingWorker, @CuttingArmClicker, @CuttingBeam, @CuttingCutStrap, @CuttingLaser, @CuttingPuncherHole, @CuttingSkiving, @PrepWorker, @PrepVerticalHF, @PrepHorizontalHF, @PrepOnlineHeatPress, @PrepAutoHF, @PrepInye, @PrepHotmeltMachine, @SewingQuantity, @SewingWorker, @SewingSmallComputer, @SewingBigComputer, @SewingUltrasonic, @Sewing4NeedleFlat, @Sewing4NeedlePost, @SewingLongTable, @SewingEyeleting, @SewingZZBinding, @SewingHotmeltMachine, @SewingHandHeldHotmelt, @SewingStationaryHHHotmelt, @StockfitQuantity, @StockfitWorker, @StockfitVerticalBuffing, @StockfitHorizontalBuffing, @StockfitSideBuffing, @StockfitOutsoleStitching, @StockfitAutoBuffing, @StockfitHydraulicCutting, @StockfitPadPrinting, @AssemblyQuantity, @AssemblyWorker, @AssemblyToeLasting, @AssemblySideLasting, @AssemblyHeelLasting, @AssemblySidePress, @AssemblyTopDown, @AssemblyHotmeltMachine, @AssemblySocklinerHotmelt, @AssemblyVWrinkleRemover) > 0)
            {
                return true;
            }
